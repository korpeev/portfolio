...
export default {
  menuBlockClasses: (openMenu: boolean) =>
    cn(
      'flex md:justify-center md:items-center md:absolute  md:top-14 md:bg-neutral-800 md:w-screen md:h-screen transition-transform duration-300 ease-in-out md:-translate-x-full md:right-0 md:mb-2',
      {
  ...
  headerClasses: 'py-3 bg-neutral-800 sticky',
